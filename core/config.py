...
class TextWorldConfig:
    ...
    def system_prompt(self) -> str:
        ...
        parts = [
            ...
            "宿舍区分：不要把所有学生宿舍写成第七学区学生寮。常盘台/学舍之园身份对应常盘台校外宿舍或学舍之园宿舍；栅川身份对应栅川学生宿舍；某高中身份对应第七学区某高中学生寮；其他身份按程序给出的私聊位置名称写。",
            "小地图规则：程序会在 input.map_context 中给出地点、路线边、玩家/NPC位置和每回合最大移动步数；旁白必须按这张小地图理解位置，不要凭空改地点。普通行动没有数值收益时，也要写成观察、伏笔、擦肩、等待或下一轮线索，而不是消极拒绝。",
