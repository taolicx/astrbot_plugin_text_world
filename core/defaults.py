...
DEFAULT_EVENT_PRESETS = [
    ...
    DefaultEventPreset("能力开发课程加测", "学校临时追加能力测定与心理问卷，能力使用频繁的学生会更疲惫。", {"energy": -2, "mood": -1}),
    DefaultEventPreset("AIM扩散力场异常波动", "第七学区部分传感器记录到微弱AIM异常，风纪委员只公开了低风险提醒。", {"energy": -1}),
    DefaultEventPreset("Level Upper旧传闻回潮", "栅川中学和商店街有人重新提起幻想御手相关都市传说，警备员提醒不要传播可疑音频。", {"mood": -1}),
    DefaultEventPreset("暗部清扫痕迹", "第十九学区与研究所外围出现无人认领的清扫痕迹，公开新闻只称是设备回收。", {"mood": -1}),
    DefaultEventPreset("魔法侧异常目击", "第十二学区附近出现无法用普通能力开发解释的目击报告，但很快被当作都市传说处理。", {"mood": 0}),
    DefaultEventPreset("滞空回线噪声", "主干道监控短暂出现噪声，公开层面只表现为交通屏幕延迟。", {"energy": -1}),
]
...
EVENT_SEEDS = [
    ...
    "能力开发课程追加了心理问卷，学生们开始互相比较AIM测定结果。",
    "有人声称听过幻想御手的残缺音频，但风纪委员很快删除了传播源。",
    "研究所外围的封锁线移动了几米，理由仍然是设备维护。",
    "第十二学区出现无法用普通能力解释的目击报告，随后被媒体归入都市传说。",
    "没有窗户的大楼方向的警备机器人巡逻频率略有上升。",
    "滞空回线相关关键词在留言板短暂升温，几分钟后帖子集体消失。",
]
