...
- `学园都市地图_美术详细标注版_总览.png`：在美术底图上直接标出 23 个学区的名称、职能和用途。
- `学园都市地图_美术详细标注版_第七学区.png`：在第七学区底图上直接标出地点用途、内部路线和外部入口。

## 源文件

- `academy-city-map.html`：地图排版源文件。
- `academy-city-art-map.html`：美术详细版地图排版源文件。
- `academy-city-annotated-art-map.html`：美术详细标注版地图排版源文件。
...
- `tools/build_academy_city_annotated_art_map.mjs`：生成美术详细标注版 HTML。
- `tools/render_academy_city_annotated_art_map.mjs`：导出美术详细标注版 PNG。
